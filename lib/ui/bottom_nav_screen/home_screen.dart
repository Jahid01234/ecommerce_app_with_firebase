...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _getCarouselImages() async {
    ...
    QuerySnapshot qn =
        await firebaseFirestore.collection("carousel-slider").get();
                      ...
                      scrollDirection: Axis.horizontal,
                        ...
                        itemBuilder: (_,index){
                          return Card(
                            ...
                            child: Column(
                              children: [
                                AspectRatio(aspectRatio: 2,child: Image.network(productsList[index]["product-img"][0])),
                                Text("${ productsList[index]["product-name"]}"),
